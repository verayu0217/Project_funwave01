                    ...
                    <table class="table table-control  table-sm table-striped align-middle my-3">
                        ...
                        <?php foreach($resultTotal as $value) : ?>
                            <tr>
                                ...
                                <td>
                                    <a role="button" href="deleteSpot.php?spot_code=<?= $value["spot_code"] ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i>刪除</a>
                                    <a role="button" href="updateSpot.php?spot_code=<?= $value["spot_code"] ?>" class="btn btn-primary"><i class="fas fa-edit"></i>修改</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
